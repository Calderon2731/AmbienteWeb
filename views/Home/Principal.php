...
<html>
    ...
    <header>
      <nav class="navbar navbar-expand-lg shadow-sm fixed-top">
        <a class="navbar-brand" href
          ><img src="../imagenes/qafya-logo.png" /></a
        ><button
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown dropleft">
              <a
                class="nav-link notification-dropdown"
                href="#"
                role="button"
              ...
              ></a>
              <div
                class="dropdown-menu notification-dropdown-menu shadow-lg"
                aria-labelledby="notification-dropdown"
              >
                <div class="dropdown-title">
                  <a href
                    >notifications<span class="ml-2 notifications-count"
                      >(1)</span
                    ></a
    ...
    <main>
      <div class="side-nav shadow-sm">
        <ul class="list-group list-group-flush">
          <a class="list-group-item" href="dashboard.html"
            ><i class="las la-shapes la-lw"></i>dashboard</a
          ><a class="list-group-item" href="patients.html"
            ><i class="las la-user-injured la-lw"></i>patients</a
          ><a class="list-group-item" href="specialists.html"
            ><i class="las la-clinic-medical la-lw"></i>specialists</a
          ><a class="list-group-item" href="procurement.html"
            ><i class="las la-shopping-cart la-lw"></i>procurement</a
          ><a class="list-group-item" href="notifications.html"
            ><i class="las la-sms la-lw"></i>notifications</a
          >
          <hr class="divider" />
          <a class="list-group-item" href="settings.html"
            ><i class="las la-cogs la-lw"></i>settings</a
          >
        </ul>
      </div>
  ...
  <footer>
    <div class="container"><a href>www.i~afya.com</a></div>
  </footer>
