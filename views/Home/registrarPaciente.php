...
<body>
  ...
  <h4 class="text-center mt-4 mb-4">Registro de pacientes</h4>
  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-header bg-danger text-white text-center">
        <h5 class="mb-2 mt-2">Agregar Paciente</h5>
      </div>
      ...
      <div class="card-body">
        <form action="" method="post">
          ...
          <div class="text-center mt-4">
            <button class="btn btn-danger btn-info px-4" id="btnProcesarAgregadoPaciente"
              name="btnProcesarAgregadoPaciente" type="submit">
              Procesar
            </button>
          </div>
        </form>
